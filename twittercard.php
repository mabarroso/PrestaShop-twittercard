...
class Twittercard extends Module
{
	...
	public function getContent()
	{
		...
		//$this->_html .= '
		//<div style="position:absolute;top:300px;right:130px;background:#7B0099;border-radius:5px;-moz-border-radius:5px;-webkit-border-radius:5px;color:#000000;width:170px;height:150px;border:2px solid #7B0099;padding:15px;">
